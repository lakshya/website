...
rsscontentdata.news[0] = {
		...
		title:"<   Library project   > <br/><br/>Encouraging students to embrace the book reading habit. <br/> Donate a book today!",
		description:" ",
		date:""
	};
...
rsscontentdata.news[1] = {
		...
		title:"<   Innovation project   > <br/><br/>Live coverage of the presentations streamed at Lakshya Live!! <br/>Click here to view the feed.<br/>",
		description:" ",
		date:""
	};
...
rsscontentdata.news[2] = {
		...
		title:"< Scholarships > <br/><br/>Final list of scholars shortlisted for funding have been uploaded. <br/> Click here to view them.",
		description:" ",
		date:""
	};