...
if($_REQUEST['action']=="submit")
{
	...
	for($i=0;$i<$ex_count-1;$i++)
	{
		...
		if($_REQUEST['delete'.$i]!=1)
		{
			...
			if(!is_notempty($name))
			{
				$_SESSION['warn']="PLEASE ENTER EXAM NAME ".($i+1);
				header("Location: edit_ex_details.php");
				exit();
			}
		
			$year=$_REQUEST['year'.$i];
			
			$result_ex=$_REQUEST['result'.$i];
			if(!is_notempty($result_ex))
			{
				$_SESSION['warn']="PLEASE ENTER RESULT ".($i+1);
				header("Location: edit_ex_details.php");
				exit();
			}
			
			$ex_det=($j+1)." YY ".$name."  YY ".$year." YY ".$result_ex." XXX ";
	...
	header("Location: fm_details.php");
	exit();
                ...
                <tr>
                  ...
                  <td width="446" valign="top"><div class="Block">
                    ...
                    <div class="Block-body">
                      <div class="BlockHeader">
                        <div class="header-tag-icon">
                          <div class="t">OTHER EXAM  DETAILS </div>
                        </div>
                      </div>
                      <div class="BlockContent">
                        <div class="BlockContent-body">
                          <div style="overflow:auto; height:500px">
                            <p>&nbsp;</p>
							<form method="post" action="edit_ex_details.php?action=submit" onsubmit="return checkeditex(this);">
				...
				?></td>
							...
							<p align="center"><br />
							  <?php for($i=0;$i<$ex_count-1;$i++)
							  {
                                ...
                                <tr>
                                  <td align="right" class="text1">EXAM NAME</td>
                                  <td>&nbsp;&nbsp; </td>
                                  <td class="text3"><input type="text" name="name'.$i.'" value="'.$ex_det_array[1].'"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="right" class="text1">YEAR </td>
                                  <td>&nbsp;&nbsp; </td>
                                  <td class="text3"><select name="year'.$i.'" id="relation">
								';
								if($ex_det_array[2]!="")
								  {
                                  	echo '<option selected="selected">'.$ex_det_array[2].'</option>';
								  }
									for($k=2000;$k<=2020;$k++)
						  		 {
                                ...
                                <tr>
                                  <td align="right" class="text1">RESULT</td>
                                  <td>&nbsp;</td>
                                  <td class="text3"><textarea name="result'.$i.'">'.$ex_det_array[3].'</textarea></td>
                                </tr>
                              </table>
							  <br />';
							  }
							...
							<table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right"><a href="ex_details.php">
