...
if($_REQUEST['action']=="submit")
{
	...
	if(!is_notempty($fname))
	{
		$_SESSION['warn']="PLEASE ENTER FIRSTNAME";
		header("Location: edit_ps_details.php");
		exit();
	}
	
	$sql_update="update lakshya_student_ps_details set fname='{$fname}' where uid='{$uid}'";
	mysql_query($sql_update);
	
	$lname=$_REQUEST['lname'];
	if(!is_notempty($lname))
	{
		$_SESSION['warn']="PLEASE ENTER LASTNAME";
		header("Location: edit_ps_details.php");
		exit();
	}
	
	$sql_update="update lakshya_student_ps_details set lname='{$lname}' where uid='{$uid}'";
	mysql_query($sql_update);
	...
	$sql_update="update lakshya_student_ps_details set dob='{$dob}' where uid='{$uid}'";
	mysql_query($sql_update);
	
	$sex=$_REQUEST['sex'];
	
	$sql_update="update lakshya_student_ps_details set sex='{$sex}' where uid='{$uid}'";
	mysql_query($sql_update);
	
	$rollno=$_REQUEST['rollno'];
	if(!is_notempty($rollno))
	{
		$_SESSION['warn']="PLEASE ENTER PROPER ROLLNO";
		header("Location: edit_ps_details.php");
		exit();
	}
	
	$sql_update="update lakshya_student_ps_details set rollno='{$rollno}' where uid='{$uid}'";
	mysql_query($sql_update);
	
	$branch=$_REQUEST['branch'];
	
	$sql_update="update lakshya_student_ps_details set branch='{$branch}' where uid='{$uid}'";
	mysql_query($sql_update);
	
	$batch=$_REQUEST['batch'];

	$sql_update="update lakshya_student_ps_details set batch='{$batch}' where uid='{$uid}'";
	mysql_query($sql_update);
              ...
              <table width="606" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="446" valign="top"><div class="Block">
                    ...
                    <div class="Block-body">
                      <div class="BlockHeader">
                        <div class="header-tag-icon">
                          <div class="t">PERSONAL DETAILS </div>
                        </div>
                      </div>
                      <div class="BlockContent">
                        <div class="BlockContent-body">
                          <div style="overflow:auto; height:500px">
                            <p>&nbsp;</p>
							<form method="post" action="edit_ps_details.php?action=submit" onsubmit="return checkeditps(this);">
								<?php $sql="select * from lakshya_student_ps_details where uid='{$uid}'";
								  $result=mysql_query($sql);
								  $row=mysql_fetch_array($result);
							?>
                            <table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="133" colspan="3" align="center"><?php 
				...
				?></td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;&nbsp; </td>
                                <td><input name="fname" type="text" id="fname" style="width: 150px;" value="<?php echo $row['fname'];?>"/></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><input name="lname" type="text" id="lname" style="width: 150px;" value="<?php echo $row['lname'];?>"/></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                <td align="right" class="text1">DATE OF BIRTH </td>
                                <td>&nbsp;&nbsp; </td>
                                <td>
								<?php $dob=$row['dob'];
									  $dob_array=split("-",$dob);
				    			...
				    			?>
                                 ...
                                 <?php if($month!="00")
								{
                                  	echo '<option selected="selected" value="'.$month.'">'.printmonth($month).'</option>';
								}
								?>
                                 <?php for($i=1;$i<=12;$i++)
						  		 {

									echo '<option value="'.$i.'">'.printmonth($i).'</option>';
                              ...
                              <tr>
                                <td align="right" class="text1">SEX&nbsp;</td>
                                <td>&nbsp;</td>
								...
								<?php if($row['sex']!="")
								  {
                                  	echo '<option selected="selected" value="'.$row['sex'].'">'.$row['sex'].'</option>';
								  }
								  ?>
                                                                </select></td>
                              </tr>
                              ...
                              <tr>
                                <td align="right" class="text1">ROLL NO&nbsp;</td>
                                <td>&nbsp;&nbsp; </td>
                                <td><input name="rollno" type="text" id="rollno" style="width: 150px;" value="<?php echo $row['rollno'];?>"/></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                <td align="right" class="text1">BRANCH</td>
                                <td>&nbsp;</td>
                                <td><select name="branch" id="branch">
								  <?php if($row['branch']!="")
								  {
                                  	echo '<option selected="selected">'.$row['branch'].'</option>';
								  }
								  ?>
                                    <option>CIVIL</option>
                                    <option>EEE</option>
                              ...
                              <tr>
								...
								<?php if($row['batch']!="")
								  {
                                  	echo '<option selected="selected" value="'.$row['batch'].'">'.$row['batch'].'</option>';
								  }
								  ?>
				    ...
				    ?>
                              ...
                              <tr>
                                <td align="right"><a href="ps_details.php">
