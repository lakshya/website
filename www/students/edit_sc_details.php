...
if($_REQUEST['action']=="submit")
{
	...
	for($i=0;$i<$sc_count-1;$i++)
	{
		...
		if($_REQUEST['delete'.$i]!=1)
		{
			...
			if(!is_notempty($name))
			{
				$_SESSION['warn']="PLEASE ENTER SCHOLORSHIP NAME ".($i+1);
				header("Location: edit_sc_details.php");
				exit();
			}
			...
			{
				$_SESSION['warn']="PLEASE ENTER AMOUNT ".($i+1);
				header("Location: edit_sc_details.php");
				exit();
			}
			...
			$sc_det=($j+1)." YY ".$name."  YY ".$amount." YY ".$comments." XXX ";
          ...
          <div>
              ...
              <table width="606" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="446" valign="top"><div class="Block">
                    ...
                    <div class="Block-body">
                      <div class="BlockHeader">
                        <div class="header-tag-icon">
                          <div class="t">SCHOLORSHIP DETAILS </div>
                        </div>
                      </div>
                      <div class="BlockContent">
                        <div class="BlockContent-body">
                          <div style="overflow:auto; height:500px">
                            <p>&nbsp;</p>
							<form method="post" action="edit_sc_details.php?action=submit" onsubmit="return checkeditsc(this);">
				...
				?></td>
							...
							<p align="center"><br />
							  <?php for($i=0;$i<$sc_count-1;$i++)
							  {
                                ...
                                <tr>
                                  ...
                                  <td>&nbsp;&nbsp; </td>
                                  <td class="text3"><input type="text" name="name'.$i.'" value="'.$sc_det_array[1].'"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="right" class="text1">AMOUNT </td>
                                  <td>&nbsp;&nbsp; </td>
                                  <td class="text3"><input type="text" name="amount'.$i.'" value="'.$sc_det_array[2].'"/></td>
                                </tr>
                                <tr>
                                  <td align="right" class="text1">&nbsp;</td>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td align="right" class="text1">COMMENTS</td>
                                  <td>&nbsp;</td>
                                  <td class="text3"><textarea name="comments'.$i.'">'.$sc_det_array[3].'</textarea></td>
                                </tr>
                              </table>
							  <br />';
							  }
							...
							<table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right"><a href="sc_details.php">
