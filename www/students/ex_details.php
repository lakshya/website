              ...
              <table width="606" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="446" valign="top"><div class="Block">
                    ...
                    <div class="Block-body">
                      <div class="BlockHeader">
                        <div class="header-tag-icon">
                          <div class="t">OTHER EXAMS  DETAILS </div>
                        </div>
                      </div>
                      <div class="BlockContent">
                        <div class="BlockContent-body">
				...
				?></td>
							  ...
							  if($exdet=="")
							  {
							  	...
							  	echo '<p align="center" class="text1">You have not added any other exam details till now.</p>';
							  }
							  ?>
							  
							  <p align="center">
                                  <button class="Button"  onclick="window.open('add_ex_detail.php','ADD','width=500,height=500');"
								  type="button" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r"></span> <span class="t">ADD EXAM DETAILS </span></span></button>
							 <?php if($exdet!="")
							  {
                                  echo '<a href="edit_ex_details.php">
