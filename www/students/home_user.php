...
<title>Welcome :: The Lakshya Foundation</title>
	...
	<script type="text/javascript" src="http://www.thelakshyafoundation.org/scripts/jquery.innerfade.js"></script></head>
<body>
                    ...
                    <div class="Block-body">
					  ...
					  <blockquote>
					    <p>
					      ...
					      <?php $sql="select * from lakshya_student_sl_details where uid='{$uid}'";
								  $result=mysql_query($sql);
								  if(mysql_affected_rows()==0)
								  {
								  	echo "Your application is not yet reviewed";
								  }
								  else
								  {
									...
									if($row['selected']=="Yes")
						  			{
					    				echo '<p class="text2"><strong></strong><div>Dear '.$_SESSION['uid'].',</div>
