                  ...
                  <td width="446" valign="top"><div class="Block">
				    ...
				    ?></td>
                              ...
                              <tr>
                                ...
                                <td valign="top">&nbsp;</td>
                                <td valign="top" class="text3"><?php echo $row['tillnow'];?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td colspan="3" align="center" valign="top">
								<a href="edit_ot_details.php"><button class="Button" type="submit" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r"></span> <span class="t">EDIT</span> </span> </button>
								  </a></td>
                                </tr>
                            </table>
                            <ul>
