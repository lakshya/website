              ...
              <table width="606" border="0" cellspacing="0" cellpadding="0">
				...
				?></td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;&nbsp; </td>
                                <td class="text3"><?php echo $row['fname'];?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td class="text3"><?php echo $row['lname'];?></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;&nbsp; </td>
                                <td class="text3"><?php if($row['dob']=="0000-00-00"){echo "";}else{echo $row['dob'];}?></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td class="text3"><?php echo $row['sex'];?></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;&nbsp; </td>
                                <td class="text3"><?php echo $row['rollno'];?></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td class="text3"><?php echo $row['branch'];?></td>
                              </tr>
                              <tr>
                                <td align="right" class="text1">&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td class="text3"><?php echo $row['batch'];?></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
								...
								<a href="edit_ps_details.php"><button class="Button" type="submit" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r"></span> <span class="t">EDIT</span> </span> </button></a></td>
                                </tr>
                            </table>
                            <ul>
                            </ul>
