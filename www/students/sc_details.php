              ...
              <table width="606" border="0" cellspacing="0" cellpadding="0">
				...
				?></td>
							  ...
							  if($scdet=="")
							  {
							  	...
							  	echo '<p align="center" class="text1">You have not added any scholorship details till now.</p>';
							  }
							  ?>
							  
							  <p align="center">
                                  <button class="Button"  onclick="window.open('add_sc_detail.php','ADD','width=500,height=500');"
								  type="button" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r"></span> <span class="t">ADD SCHOLORSHIP </span></span></button>
							  <?php if($scdet!="")
							  {
                                  echo '<a href="edit_sc_details.php">
                                   <button class="Button" type="submit" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r">
								   </span> <span class="t">EDIT</span> </span> </button>
                                  </a>';
							   } ?>
							  </p> <br />
