...
if($_REQUEST['action']=="send")
{
	...
	$sql="select * from lakshya_student_ct_details where uid='{$uid_user}'";
  	$result=mysql_query($sql);
	...
	$_SESSION['warn']="MAIL SENT SUCCESSFULLY.";
	header("Location: send_email.php?enc=".$enc_uid);
	exit();
}
?>
                    ...
                    <div class="Block-body">
                      <div class="BlockHeader">
						...
						<?php $sql="select * from lakshya_student_ct_details where uid='{$uid_user}'";
								  ...
								  $row=mysql_fetch_array($result);
							?>
                          <div class="t">EMAIL to <?php echo $row['uid'];?> ( <?php echo $row['emailid'];?> ) </div>
                        </div>
                      </div>
                    </div>
				
					<form method="post" action="send_email.php?action=send&enc=<?php echo $enc_uid;?>">
                  <table width="347" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="170" colspan="3"><?php 
			  		if($_SESSION['warn']!= NULL)
			  		{
			  			echo '<img src="images_kohana/BlockContentBullets.png" width="10" height="12" />&nbsp;<span class="text2">'.$_SESSION['warn'].'<span class="text2">';
						$_SESSION['warn']=NULL;
			  		}
				?></td>
                      </tr>
                    <tr>
                      <td width="170" valign="top" class="text1">MESSAGE</td>
                      <td width="10">&nbsp;</td>
                      <td width="171">
                        <p>
                          <label>
                            <textarea name="string" cols="25" rows="10" id="string"></textarea>
                            </label>
                        </p>                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="right"> <a href="search.php"><button class="Button" type="button" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r"></span> <span class="t">CANCEL</span></span></button></a></td>
                      <td>&nbsp;</td>
                      <td><button class="Button" type="submit" name="EDIT"> <span class="btn"> <span class="l"></span> <span class="r"></span> <span class="t">SEND</span> </span> </button></td>
                    </tr>
                    <tr>
