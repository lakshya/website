          ...
          <div>
            <form method="post" id="register" action="register_verify.php" onsubmit="return checkregister(this);">
              ...
              <table width="431" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td colspan="3" align="center" class="text1"><span class="text3"><img src="images_kohana/BlockHeaderIcon.png" alt="" width="16" height="23" /> APPLICATIONS HAVE BEEN CLOSED </span></td>
                  </tr>
                <tr>
